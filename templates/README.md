...
| `PRB.md` | Problem statement | immutable | `initiatives/<i>/PRB-NNN-slug.md` |
| `HYP.md` | Solution hypothesis | immutable | `initiatives/<i>/HYP-NNN-slug.md` |
| `WF.md` | Current / target / delta workflow | living | `products/<p>/WF.md` |
| `EVD.md` | Problem evidence brief | immutable | `initiatives/<i>/EVD-NNN-slug.md` |
| `CMP.md` | Competitor comparison | immutable | `initiatives/<i>/CMP-NNN-slug.md` |
| `DFB.md` | Data feasibility brief | immutable | `initiatives/<i>/DFB-NNN-slug.md` |
| `SD.md` | Solution design + MVA | immutable | `initiatives/<i>/SD-NNN-slug.md` |
| `EVP.md` | Evaluation plan | living, frozen for RC | `products/<p>/EVP.md` |
| `DC.md` | Data contract | living, versioned | `products/<p>/contracts/DC-NNN-slug.md` |
...
| `EVR.md` | Evaluation report | immutable | `products/<p>/releases/EVR-NNN-slug.md` |
| `REL.md` | Release note (for humans) | immutable | `products/<p>/releases/REL-NNN-slug.md` |
| `RLM.yaml` | Release manifest (for machines) | immutable | `products/<p>/releases/RLM-NNN-slug.yaml` |
...
| `ICG.md` | Impact classification gate | immutable | `products/<p>/cycles/ICG-NNN-slug.md` |
| `CHG.md` | Change contract | immutable | `products/<p>/changes/CHG-NNN-slug.md` |
